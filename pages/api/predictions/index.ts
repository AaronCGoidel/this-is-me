...
export default async function handler(req, res) {
  ...
  Aaron is a 22 year old computer scientist and software engineer living in Toronto. He recently finished his BS in computer science at the University of Toronto where he was also a research assistant working on natural language processing and a TA for Theory of Computation.
